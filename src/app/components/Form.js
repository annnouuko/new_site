...
export default function Form() {
  ...
  return (
    <div className="bg-[#e9e9e9] w-full md:w-1/2 flex flex-col items-center px-4 md:px-0">
      ...
      <div className="hidden md:flex h-[180px] w-[570px] gap-[7.5rem] ml-[210px]">
        ...
        <div className="flex items-end justify-end h-[180px] w-[410px]">
          <div className="flex flex-col h-[150px] w-[200px] space-y-[2px]">
            <Link
              href="/"
              className="h-[30px] w-[280px] text-[#A3A3A3] hover:text-gray-500 transition-colors"
            >
              HOMEPAGE
            </Link>
            <Link
            ...
            {/* CONTACT — скрыт на мобилке */}
            <Link
              href="/contacts"
              className="hidden md:block h-[30px] w-[280px] text-black font-medium"
            >
              CONTACT
            </Link>
          </div>
      ...
      {/* ТЕЛО ФОРМЫ */}
      <div className="mt-10 md:mt-16 w-full max-w-[600px] flex flex-col gap-8 md:gap-10 text-sm">
        {/* NAME */}
        <div>
          <p className="uppercase text-gray-500 text-xs mb-2">Name</p>
          <input
            type="text"
            className="w-full h-[55px] md:h-[60px] px-5 text-black text-sm rounded-md outline-none border-none bg-transparent"
            style={{
        ...
        <div>
          ...
          <textarea
            className="w-full h-28 md:h-32 px-5 py-4 text-black text-sm rounded-md outline-none border-none resize-none bg-transparent leading-relaxed"
            style={{
        ...
        {/* RADIO */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center text-sm uppercase mt-3 gap-5 md:gap-10">
          <div
        ...
        >
          <img
            src={
              isPressed
                ? "/img/send_request 1.svg"
                : "/img/send_request.svg"
            }
            alt="Send Request"
        ...
        {/* CHECKBOX */}
        <div className="flex items-start gap-2 text-gray-400 text-xs leading-snug mt-[-20px] md:mt-[-30px] max-w-[600px]">
